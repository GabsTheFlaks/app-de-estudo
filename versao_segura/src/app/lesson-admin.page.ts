              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    >
                      <option [value]="FileType.VIDEO">Vídeo (YouTube/Drive)</option>
                      <option [value]="FileType.PDF">Documento PDF</option>
                      <option [value]="FileType.DOCS">Google Docs</option>
                      <option [value]="FileType.PPTX">Slides / Apresentação</option>
                      <option [value]="FileType.XLS">Planilha</option>
                    </select>
...
export class LessonAdminPage {
  ...
  lessonForm = this.fb.group({
    ...
    description: [''],
    file_type: [FileType.VIDEO, Validators.required],
