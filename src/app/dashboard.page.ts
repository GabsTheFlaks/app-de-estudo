...
export class DashboardPage implements OnInit {
  ...
  async deleteCourse(id: string) {
    ...
    const confirmed = window.confirm("Tem certeza que deseja apagar esta turma e todos os seus materiais?");
    if (confirmed) {
      try {
  ...
  async renameCourse(course: Course) {
    ...
    const newTitle = window.prompt("Digite o novo nome para a turma:", course.title);
